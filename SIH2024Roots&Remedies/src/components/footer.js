...
Footer.defaultProps = {
  column2Title: 'Learn More',
  link7: 'Disclaimer',
  link5: 'Terms of Use',
  link8: 'FAQs',
  action1: 'Subscribe to Newsletter',
  content3: '© 2023 Virtual Herbal Garden. All Rights Reserved.',
  link4: 'Privacy Policy',
  logoSrc: 'https://presentation-website-assets.teleporthq.io/logos/logo.png',
  cookiesLink: '/cookies-policy',
  content2:
    'Connect with us on social media for more updates and tips on herbal gardening.',
  link9: 'Blog',
  link6: 'Cookies Policy',
  logoAlt: 'Virtual Herbal Garden Logo',
  link1: 'Home',
